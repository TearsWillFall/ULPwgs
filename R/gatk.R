  ...
  ...
   ...
   run_main=function(
    ...
    .main$exec_code=paste(
      ...
      " -F2 ",input$fastq_r2,
      " -O ",.main$out_files$bam,
      ifelse(!is.null(tmp_dir),paste(" --TMP_DIR ",tmp_dir)," "),
      tag_annot
    )
            ...
            tryCatch({
              ...
              if(steps[step]=="before_bqsr"){
                  ...
                  .main.step$steps$new_generate_BQSR_gatk.before<-
                              ...
                              output_dir=paste0(out_file_dir,"/recal/before_recal/tables"),
              ...
              if(steps[step]=="apply_bqsr"){
                .main.step$steps$new_apply_BQSR_gatk<- 
                            ...
                            bam=input,
                            region=regions$regions,
                            rec_table=.main.step$out_files$before_bqsr$table$merged,
                            output_dir=paste0(out_file_dir,"/recal/bam"),
                            output_name=paste0(input_id),
                            tmp_dir=tmp_dir,
                            env_dir=env_dir,
                            batch_dir=batch_dir,
                ...
                if(steps[step]=="gather_bam"){
                  ...
                  .main.step$steps <-append(
                            .main.step$steps,
                              ...
                              output_dir=paste0(out_file_dir,"/recal/bam"),
                              output_name=paste0(input_id,".recal",sub(".bam$","",get_file_ext(input))),
                              tmp_dir=tmp_dir,
                              env_dir=env_dir,
                              batch_dir=batch_dir,
                              err_msg=err_msg,
                  ...
                  .main.step$steps <-append(
                      .main.step$steps,
                          new_sort_and_index_bam_samtools(
                                  ...
                                  stats=TRUE,
                                  clean=TRUE,
                                  output_dir=paste0(out_file_dir,"/recal/bam/sorted"),
                                  output_name=paste0(input_id,".recal",sub(".bam$","",get_file_ext(input))),
                                  tmp_dir=tmp_dir,
                                  env_dir=env_dir,
                                  batch_dir=batch_dir,
              ...
              if(steps[step]=="analyze_covariates"){
                  .main.step$steps <-append(
                          .main.step$steps,
                            ...
                            output_dir=paste0(out_file_dir,"/recal/covariates"),
                            output_name=paste0(input_id),
                            tmp_dir=tmp_dir,
                            env_dir=env_dir,
                            batch_dir=batch_dir,
