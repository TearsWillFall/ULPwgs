    ...
    lapply(unique(seq_info$project_id),FUN=function(project_id){
        ...
        lapply(unique(seq_info_per_project$patient_id),FUN=function(patient_id){
            ...
            lapply(unique(seq_info_per_patient$sample_id),FUN=function(sample_id){
                ...
                cat(paste0("\t\t",add_bl(),rep(add_l(),2),"Sample ID: ",sample_id,"\n"))
                ...
                seq_info_per_sample=seq_info_per_patient %>% filter(sample_id==sample_id)
                    ...
                    lapply(unique(seq_info_per_sample$method_id),FUN=function(method_id){
                        ...
                        cat(paste0("\t\t\t",add_bl(),rep(add_l(),3),"Method ID: ",method_id,"\n"))
                        ...
                        lapply(unique(seq_info_per_method$flowcell_id),FUN=function(flowcell_id){
                            ...
                            cat(paste0("\t\t\t\t",add_bl(),rep(add_l(),4),"Flowcell ID: ",flowcell_id,"\n"))
                            ...
                            lapply(unique(seq_info_per_method$lane_id),FUN=function(lane_id){
                                ...
                                cat(paste0("\t\t\t\t\t",add_bl(),rep(add_l(),5),"Lane ID: ",lane_id,"\n"))
                                ...
                                lapply(unique(seq_info_per_lane$library_id),FUN=function(library_id){
                                        cat(paste0("\t\t\t\t\t\t",add_bl(),rep(add_l(),5),"Library ID: ",library_id,"\n"))
                                        ...
                                        cat(paste0("\t\t\t\t\t\t\t",add_bl(),rep(add_l(),6),"R1: ",seq_info_per_library$read_group[seq_info_per_library$read_group=="R1"]$path,"\n"))
                                        cat(paste0("\t\t\t\t\t\t\t",add_bl(),rep(add_l(),6),"R2: ",seq_info_per_library$read_group[seq_info_per_library$read_group=="R2"]$path,"\n"))
                                })
                            })
                        })
                    })
