        ...
        for(step in 1:total_steps){
                ...
                .main.step$steps <-append(
                        ...
                        merge_bam_umi_gatk(
                                ...
                                bam=list(list(
                                    ...
                                    unmapped=.main.step$out_files$raw$bam$unmapped$umi$bam)),
            ...
            if(steps[step]=="tag_consensus"){
                ...
                merge_bam_umi_gatk(
                        ...
                        ref_genome=ref_genome,
                        bam=list(list(
                            mapped=.main.step$out_files$consensus$bam$mapped$untagged$bam,
                            unmapped=.main.step$out_files$consensus$bam$unmapped$bam)),
                        attributes=c("X0","RX"),
